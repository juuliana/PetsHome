...
public class Funcionario {
    ...
    /**
     * @param func_end the func_end to set
     */
    ...
    /**
     * @return the func_contato
     */
    public String getFunc_contato() {
        return func_contato;
    }

    /**
     * @param func_contato the func_contato to set
     */
    public void setFunc_contato(String func_contato) {
        this.func_contato = func_contato;
    }
